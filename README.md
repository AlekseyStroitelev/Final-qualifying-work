...
Данная работа далека от идеала и включает в себя определенный перечь действий, которые необходимо совершать вручную.
Так же был упущен момент с отдельным аккаунтом для управления и развертывания инфраструктуры. В целом, результат считаю удовлетворительным.
